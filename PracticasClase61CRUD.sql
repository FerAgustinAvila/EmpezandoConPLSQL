/*
Crear un bloque inserte un nuevo departamento en la tabla DEPARTMENTS.. 
Para saber el DEPARTMENTI_ID que debemos asignar al nuevo departamento primero debemos averiguar el valor mayor que hay
en la tabla DEPARTMENTS y sumarle uno para la nueva clave.

o Location_id debe ser 1000
o Manager_id debe ser 100
o Department_name debe ser “INFORMATICA”
o NOTA: en PL/SQL debemos usar COMMIT y ROLLBACK de la misma forma que lo hacemos en SQL. 
Por tanto, para validar definitivamente un cambio debemos usar COMMIT. Podemos
*/
