...
C*rear una zona de EXCEPTION controlando el NO_DATA_FOUND para que pinte un mensaje como “Empleado inexistente”
*/
...
/*
2-Modificar la SELECT para que devuelva más de un empleado, por ejemplo poniendo EMPLOYEE_ID> 100. 
Debe generar un error. Controlar la excepción para que genere un mensaje como “Demasiados empleados en la consulta”
*/
...
vamos a devolver el salario en vez del nombre y lo dividimos por 0. 
...
Aunque ya existe una predefinida (DUP_VAL_ON_INDEX) vamos a crear una excepción no -predefinida que haga lo mismo. 
O vamos a usar la tabla REGIONS para hacerlo más fácil o Usamos PRAGMA EXCEPTION_INIT y 
creamos una excepción denominada “duplicado”. 
Cuando se genere ese error debemos pintar “Clave duplicada, intente otra”. 
O insertamos una fila en la tabla REGIONS que esté duplicada y vemos que se controla el error
*/
